...
const smoothControl=document.querySelector('#smooth'),rawButton=document.querySelector('#raw'),filteredButton=document.querySelector('#filtered');
...
let smooth=true,spectrumMode='raw';
